#ifndef _JacobiTest_HPP_
#define _JacobiTest_HPP_
...
namespace test {
    class JacobiTest : public InspExecTest { //BenchmarkTest {

    protected:
        JacobiTest(const string& name = "JacobiTest") : InspExecTest(name) {
        }
