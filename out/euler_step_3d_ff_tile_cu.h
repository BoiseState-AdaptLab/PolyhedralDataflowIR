...
inline double euler_step(const double* U, double* rhs) {
    ...
    d_params->array0 = (double*) cuda_malloc(1866240 * sizeof(double));
    d_params->array1 = (double*) cuda_malloc(5 * sizeof(double));
    d_params->array2 = (double*) cuda_malloc(5 * sizeof(double));
    d_params->array3 = (double*) cuda_malloc(1715000 * sizeof(double));
    d_params->array4 = (double*) cuda_malloc(1617000 * sizeof(double));
    d_params->array5 = (double*) cuda_malloc(1617000 * sizeof(double));
    d_params->array6 = (double*) cuda_malloc(1592500 * sizeof(double));
    d_params->array7 = (double*) cuda_malloc(1592500 * sizeof(double));
    d_params->array8 = (double*) cuda_malloc(5 * sizeof(double));
    d_params->array9 = (double*) cuda_malloc(1502800 * sizeof(double));
    d_params->array10 = (double*) cuda_malloc(5 * sizeof(double));
    d_params->array11 = (double*) cuda_malloc(5 * sizeof(double));
    d_params->array12 = (double*) cuda_malloc(1592500 * sizeof(double));
    d_params->array13 = (double*) cuda_malloc(1592500 * sizeof(double));
    d_params->array14 = (double*) cuda_malloc(5 * sizeof(double));
    d_params->array15 = (double*) cuda_malloc(1502800 * sizeof(double));
    d_params->array16 = (double*) cuda_malloc(5 * sizeof(double));
    d_params->array17 = (double*) cuda_malloc(5 * sizeof(double));
    d_params->array18 = (double*) cuda_malloc(1592500 * sizeof(double));
    d_params->array19 = (double*) cuda_malloc(1592500 * sizeof(double));
    d_params->array20 = (double*) cuda_malloc(5 * sizeof(double));
    d_params->array21 = (double*) cuda_malloc(1502800 * sizeof(double));
    ...
    cuda_free(d_params->array0);
    cuda_free(d_params->array1);
    cuda_free(d_params->array2);
    cuda_free(d_params->array3);
    cuda_free(d_params->array4);
    cuda_free(d_params->array5);
    cuda_free(d_params->array6);
    cuda_free(d_params->array7);
    cuda_free(d_params->array8);
    cuda_free(d_params->array9);
    cuda_free(d_params->array10);
    cuda_free(d_params->array11);
    cuda_free(d_params->array12);
    cuda_free(d_params->array13);
    cuda_free(d_params->array14);
    cuda_free(d_params->array15);
    cuda_free(d_params->array16);
    cuda_free(d_params->array17);
    cuda_free(d_params->array18);
    cuda_free(d_params->array19);
    cuda_free(d_params->array20);
    cuda_free(d_params->array21);
    cuda_free(d_params);
