// 'conjgrad_csr' code generated by 'edavis' at 07/08/2019 11:09:02
#include <stdio.h>
#include <stdlib.h>
#include <stdint.h>
#include <math.h>
...
// copy+spmv+ddot+rdot0+adiv+xadd+rsub+rdot+bmul+dadd
#undef s0
#define s0(i) r[(i)]=d[(i)]=b[(i)]
#undef s1
...
#pragma omp parallel for schedule(auto) private(t2,t4,t6,t7)
for(t2 = 1; t2 <= T; t2++) {
    for(t4 = 0; t4 <= N-1; t4++) {
        #pragma omp simd
