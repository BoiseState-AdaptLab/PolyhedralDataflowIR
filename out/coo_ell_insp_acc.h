...
#undef s2
#define s2(n,i) (*lcol)[offset2((i),(k),(K))]=col((n))
#undef s3
#define s3(n,i) (*lval)[offset2((i),(k),(K))]=val((n))
#undef s4
#define s4(n,i) k+=1
#undef s5
#define s5(n,i) p=(i)
...
size = K * (*N);
*lcol = (unsigned*) calloc(size, sizeof(unsigned));
*lval = (double*) calloc(size, sizeof(double));
