...
unsigned coo_hicoo_3d_insp(const float* val, const unsigned B, const unsigned M, const unsigned N, const unsigned* dims, const unsigned* indices, float** bval, unsigned short** bindices, unsigned** bp, unsigned char** eindices);
inline unsigned coo_hicoo_3d_insp(const float* val, const unsigned B, const unsigned M, const unsigned N, const unsigned* dims, const unsigned* indices, float** bval, unsigned short** bindices, unsigned** bp, unsigned char** eindices) {
